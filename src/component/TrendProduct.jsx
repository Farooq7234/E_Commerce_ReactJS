...
function TrendProduct({ category, productName, image, productPrice }) {
  ...
  return (
    <>
      <div className='mt-5 h-auto mx-4 max-sm:mx-0 bg-white hover:bg-slate-50 hover:cursor-pointer flex flex-col justify-center items-center rounded-2xl shadow-2xl max-sm:w-full  border-black '>
        <img
