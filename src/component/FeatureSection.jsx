...
function FeatureSection({products,productImg}) {
  return (
   <>
    <div className='dark:bg-[#333232] dark:text-white relative max-sm:mt-4 mx-5 h-auto  w-62 sm:52 bg-white flex flex-col p-5 rounded-md shadow-md  justify-start items-start pt-2'>
