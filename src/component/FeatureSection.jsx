...
function FeatureSection({products,productImg}) {
  return (
   <>
    <div className='dark:bg-[#333232] dark:text-white relative max-sm:mt-4 mx-5 h-auto  w-62 sm:52 bg-white flex flex-col p-5 rounded-md shadow-md  justify-start items-start mt-2'>
    ...
    <ActionButton/>
    <img className='h-auto  w-1/3 sm:my-3 sm:h-14 sm:w-1/2 ' src={`https://o.remove.bg/downloads/${productImg}`} alt={`product: ${products}`} />
    </div>
    </div>
   </>
  )
