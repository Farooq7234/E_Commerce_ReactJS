        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 place-items-center gap-5'>
          {
            customerReviews.map((customer,index) =>
              <div className=' bg-white w-[300px] sm:w-[350px]  h-72 dark:bg-[#333333]  rounded-md shadow-md flex justify-center gap-5 items-center flex-col border-2 border-gray-50 ' key={index}>
