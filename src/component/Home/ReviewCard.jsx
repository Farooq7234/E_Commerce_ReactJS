        ...
        <div className='flex justify-around items-center flex-wrap gap-5'>
          {
            customerReviews.map((customer,index) =>
              <div className=' bg-white w-[90%] md:w-[350px]  h-56 dark:bg-[#333333]  rounded-md shadow-md flex justify-center gap-5 items-center flex-col border-2 border-gray-50 ' key={index}>
