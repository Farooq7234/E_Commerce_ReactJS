...
function LogoContainer() {
  return (
    <div className='h-auto w-auto flex justify-center items-center flex-wrap pt-5 px-5 dark:dark:bg-[#323232]'>
      <h2 className='text-base font-semibold max-sm:text-sm w-1/2 text-center dark:text-white '>Featured Brands:</h2>
      <div className='flex flex-wrap justify-center items-center dark:dark:bg-[#323232]'>
