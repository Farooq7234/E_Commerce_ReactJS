...
function AboutCard() {
  ...
  return (
    <>
    <div className='flex flex-col gap-5 bg-white shadow-lg rounded w-1/2 max-sm:w-auto py-3 px-4 dark:bg-[#333232] dark:text-white'>
    ...
    <div className='flex flex-col gap-2 px-5 max-sm:px-0'>
      ...
      <ul className='text-sm'>
        <li className='flex justify-start items-center gap-1 mt-2'><IoIosCheckbox className='text-green-500'/> Fresh fruits</li>
